      ...
      <main className={styles.main}>
        <div className={styles.s1}>
          <div className={styles.text}>
            ...
            <p>Successful founders get three things right — they make a great product, hire an amazing team, and set a vision. But the best founders? They use every ounce of capital available to constantly perfect their business.</p>
