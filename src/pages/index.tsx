        ...
        <div className={styles.s1}>
          <div className={styles.text}>
            <h3>Lifeblood for Founders</h3>
              ...
              <p>Successful founders get three things right — they make a great product, hire an amazing team, and set the vision. But the best founders? They use every ounce of capital available to bet on their vision. And sometimes they win big.</p>
