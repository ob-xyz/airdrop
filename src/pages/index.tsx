        ...
        <div className={styles.s1}>
          <div className={styles.text}>
            <h3>Lifeblood for Founders</h3>
              <p>Inspired by AngelList, we believe founders are like gods reinventing the world.</p>
              <p>Successful founders get three things right — they make a great product, hire an amazing team, and set the vision. But the best founders? They use every ounce of capital available to bet on themselves. And sometimes they win big.</p>
